...
@HiltViewModel
class HotelRoomsViewModel @Inject constructor(private val repository: com.jedvobet.domain.HotelRoomsRepository) :
    ViewModel() {

    private val _hotelRoomsList =
        MutableLiveData<List<Room>>()
    val hotelRoomsList: LiveData<List<Room>> =
        _hotelRoomsList
